...
The development is coordinated on `GitHub <http://github.com/cosmo-ethz/ivy>`_ and contributions are welcome. The documentation of **ivy** is available at `readthedocs.org <http://hide.readthedocs.io/>`_ .
